...
namespace DBS
{
    public partial class Form5 : Form
    {
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show("Inserted Into Billing Table");
            conn.Close();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(checkBox1.Checked)
            {
                ...
                //MessageBox.Show("Inserted into Uses_Voucher Table!");
                ...
                //MessageBox.Show("updated after voucher applied");
